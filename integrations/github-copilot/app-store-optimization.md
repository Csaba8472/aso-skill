...
- **Apple App Store**: Title (30 chars), Subtitle (30 chars), Promotional Text (170 chars), Description (4,000 chars), Keywords (100 chars)
- **Google Play Store**: Title (50 chars), Short Description (80 chars), Full Description (4,000 chars)

## How to Use

### Keyword Research
```
Help me research the best keywords for a productivity app targeting professionals.
Focus on keywords with good search volume but lower competition.
```

### Optimize App Store Listing
```
Optimize my app's metadata for the Apple App Store.
App: [name], Category: [category], Key features: [features], Target keywords: [keywords]
```

### Analyze Competitor Strategy
```
Analyze the ASO strategies of [Competitor 1], [Competitor 2], and [Competitor 3].
Identify what they're doing well and where there are opportunities.
```

### Review Sentiment Analysis
```
Analyze recent reviews for my app and identify the most common user complaints and feature requests.
```

### Calculate ASO Score
```
Calculate my app's overall ASO health score and provide specific recommendations for improvement.
Metrics: [average rating, keyword rankings, conversion rate, metadata details]
```

### Plan A/B Test
```
I want to A/B test my app icon and first screenshot.
Help me design the test and determine how long to run it.
```

### Pre-Launch Checklist
```
Generate a comprehensive pre-launch checklist for submitting my app to both Apple App Store and Google Play Store.
Launch date: [date]
```
